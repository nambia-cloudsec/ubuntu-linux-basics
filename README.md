...
## 📚 Linux Phases Covered

### **Linux Notes (Theory)**
- Phase 1 → Phase 10 included in `linux-notes`

### **Linux Labs (Practical)**
...
- **Tools:** Git, GitHub, VirtualBox, VS Code
- **Concepts:** Cloud Security, Linux Foundations, File System Management, Process Management, Scripting Automation

---

## 📄 CV

- Internship-ready CV: [Download Nambia_CV.pdf](./Nambia_CV.pdf)
